...
import { downloadAuditLogs, downloadErrorLogs, listAuditLogs, listErrorLogs, monitoringSummary, socketStatus } from "../controllers/monitoringController.js";
...
router.get("/security/monitoring", adminOrSuper, monitoringSummary);
router.get("/security/socket", adminOrSuper, socketStatus);
router.get("/security/audit-logs", adminOrSuper, listAuditLogs);
router.get("/security/error-logs", adminOrSuper, listErrorLogs);
router.get("/security/audit-logs.csv", adminOrSuper, downloadAuditLogs);
router.get("/security/error-logs.csv", adminOrSuper, downloadErrorLogs);
