...
import { listPublic, registerPublicTeam, getSportDetailView, getPublicRegistrationFields } from "../controllers/publicController.js";
...
router.get("/registration-fields", getPublicRegistrationFields);
